...
class rlAgentQL:
    ...
    def __init__(self, FrozenLake, alpha = 0.25, epsilon = 0.1, maxsteps = 500, max_episodes = 5000, discount_factor = 0.99, decaying = False):
        ...
        self.step_num = 1
        self.episode_num = 0
        self.episodes = range(0,2000,5)         # change self.episodes to calculate the discounted rewards in different intervals
    ...
    def calcDiscountedReward(self, max_iters = 500, verbose = False):
